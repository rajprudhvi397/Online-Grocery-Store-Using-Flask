from flask import Blueprint,render_template # Importing Blueprint to handle routes related to editDashboardCategory page
...
@editDashboardCategory.route('/')
def renderEditDashboardCategoryPage():
    ''' This is the function that will run when someone called for '/' route '''
    return render_template('editDashboardCategory.html') # Rendering editDashboardCategory.html page